const ClassService         = require('../../Class/index'),
	  AssignmentService    = require('../db/index'),
	  NewAssignmentNotif   = require('../../Notification/Categories/Academic/New Assignment/NewAssignmentNotif');
class AssignmentHandler{
	...
	static async new(userID, classID, assData){
		try{
			...
			await NewAssNotif.push(newAssignment._id, updatedClass);

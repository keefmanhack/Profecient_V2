...
function Header(props){
	return(
		<div className='top-bar black-bc' style={style_topBar}>
			...
			<span className='not'>
				<button className='green-c'><i className="fas fa-pencil-alt"></i></button>
				<button className='green-c'><i className="fas fa-user-friends"></i></button>
				<Link to='/message'>
					<button className='green-c'><i className="fas fa-comments"></i></button>
				</Link>
			</span>
